...
//					.first();
//			if (docType == null) {
//				docType = new Query(Env.getCtx(), MDocType.Table_Name, "lit_fepa_doctype = 'TD01' and issotrx='N' ",
...
//		}
//
//		List<DatiRitenutaType> ritenute = body.getDatiGenerali().getDatiGeneraliDocumento().getDatiRitenuta();
...
//	}
//
//	private byte[] getXml(RemoteResourceInfo entry, SFTPClient sftp) throws Exception {
